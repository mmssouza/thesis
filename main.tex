...
\textbf{Palavras-chaves}: 
 Recuperação de imagens pelo conteúdo. Análise de formas. Energia de dobramento multiescala. Entropia multiescala. Análise de similaridade de formas. Medidas de divergência.
\end{resumo}
...
\vspace{\onelineskip}
\noindent 
\textbf{Key-words}: Content-based image retrieval. Shape analysis. Multiscale shape descriptor. Multiscale entropy. Shape similarity. Evolutionary optimization. Divergence measures. Manifold learning.
 \end{otherlanguage*}
\end{resumo}
