...
\noindent\\ 
\textbf{Key-words}: 
Content-based image retrieval. Shape analysis. Multiscale shape descriptor. Multiscale entropy. Shape similarity. Evolutionary optimization. Divergence measures. Manifold learning.
 \end{otherlanguage*}
\end{resumo}
